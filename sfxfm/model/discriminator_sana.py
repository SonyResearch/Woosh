"""
This defines a discriminator model based on SANA:
https://github.com/NVlabs/Sana/blob/main/diffusion/model/nets/ladd_blocks.py

DiscHead iss adapted from:
https://github.com/autonomousvision/stylegan-t/blob/main/networks/discriminator.py
"""
...
class DiscHeadNetwork(nn.Module):
